...
const subcategories = [
  { name: "Footwear", path: "/turf/footwear", image: "/images/turf/footwear.jpg" },
  { name: "Apparel", path: "/turf/apparel", image: "/images/turf/apparel.jpg" },
  { name: "Accessories", path: "/turf/accessories", image: "/images/turf/accessories.jpg" },
  { name: "Bags", path: "/turf/bags", image: "/images/turf/bags.jpg" },
  { name: "Balls", path: "/turf/balls", image: "/images/turf/balls.jpg" },
  { name: "Socks", path: "/turf/socks", image: "/images/turf/socks.jpg" },
  { name: "Shin Guards", path: "/turf/shinguards", image: "/images/turf/shinguards.jpg" },
];
...
const newLaunches = [
  {
    ...
    price: "₹1,999",
    image: "/images/turf/new1.jpg",
  },
  {
    name: "Astro Grip Turf Shoes",
    price: "₹2,199",
    image: "/images/turf/new2.jpg",
  },
  {
    name: "Rider Pro Ball",
    price: "₹799",
    image: "/images/turf/new3.jpg",
  },
  {
    name: "Edge Turf Boots",
    price: "₹2,499",
    image: "/images/turf/new4.jpg",
  },
];

const shopByLevel = [
  { title: "Beginner", image: "/images/turf/level1.jpg" },
  { title: "Intermediate", image: "/images/turf/level2.jpg" },
  { title: "Advanced", image: "/images/turf/level3.jpg" },
];

const blogs = [
  {
    title: "Best Turf Shoes for 2025",
    date: "July 1, 2025",
    description: "Explore top-performing shoes that give you grip and style.",
    image: "/images/turf/blog1.jpg",
    link: "#",
  },
  {
    title: "Maintaining Your Turf Gear",
    date: "June 12, 2025",
    description: "Simple cleaning and storage tips to extend product life.",
    image: "/images/turf/blog2.jpg",
    link: "#",
  },
  {
    title: "Why Turf-Specific Footwear Matters",
    date: "May 30, 2025",
    description: "Avoid injuries and improve traction with proper turf shoes.",
    image: "/images/turf/blog3.jpg",
    link: "#",
  },
];
